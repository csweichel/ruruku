...
gox -os="$GOXOS" -arch="386 amd64" -output="build/release/ruruku$VERSION{{.OS}}_{{.Arch}}" -ldflags "-s -w -X cmd.Rev=`git rev-parse --short HEAD`" -verbose github.com/32leaves/ruruku
